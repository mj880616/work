...
if(q.get('native')==='android'&&location.hash){
  ...
  (async()=>{
    ...
    try{
      ...
      const target='intent://auth?handoff='+encodeURIComponent(d.token)+'#Intent;scheme=kptuwork;package=kr.or.kptu.work;end';
      ...
      const fallback='intent://auth?payload='+encodeURIComponent(payload)+'#Intent;scheme=kptuwork;package=kr.or.kptu.work;end';
