...
function enhanceAuth(){
  ...
  if(document.querySelector('#googleLoginBtn')){document.querySelector('#authPreloadStyle')?.remove();return true}
  ...
  document.querySelector('#authPreloadStyle')?.remove();return true
}
