...
import('./pwa.js?v=1');
import('./meeting-assignee-picker.js?v=1').then(()=>import('./loader-v2.js?v=71')).catch(err=>{console.error(err);document.querySelector('#authPreloadStyle')?.remove();document.body.insertAdjacentHTML('beforeend','<pre style="padding:16px;color:#a33b45">앱 초기화 오류: '+String(err.message||err)+'</pre>')});