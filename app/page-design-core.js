(()=>{
  ...
  function ensureStyles(){
    ...
    s.textContent=`
      ...
      .pd-forum-flow{margin:8px 0 2px;padding:16px;border-radius:16px;background:#fff;border:1px solid #dbe4ea}.pd-flow-top{display:flex;align-items:stretch;justify-content:center;gap:7px}.pd-flow-node{display:flex;align-items:center;justify-content:center;text-align:center;min-height:62px;flex:1;padding:10px 9px;border-radius:13px;font-weight:850;line-height:1.35;border:1px solid transparent}.pd-flow-arrow{display:flex;align-items:center;font-size:23px;font-weight:900;color:#718495}.pd-flow-red{background:#f9dedc;border-color:#efc5c2;color:#8d292c}.pd-flow-redsoft{background:#fae6df;border-color:#efd0c5;color:#8a3e2d}.pd-flow-amber{background:#fbe9cf;border-color:#efd6af;color:#805326}.pd-flow-yellow{background:#fff2c9;border-color:#eddc9c;color:#765c16}.pd-flow-danger{background:#f6dddd;border-color:#e8bebe;color:#8e2f34}.pd-flow-branch{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:24px;position:relative}.pd-flow-branch:before{content:'';position:absolute;left:25%;right:25%;top:-13px;border-top:2px solid #8ba0b0}.pd-flow-track{border-radius:15px;padding:0;border:1px solid;overflow:hidden}.pd-flow-problem,.pd-flow-solution{padding:15px 14px;text-align:center;font-weight:850;line-height:1.45}.pd-flow-down{text-align:center;font-size:23px;font-weight:900;padding:2px 0}.pd-flow-blue{border-color:#b9d5ee;background:#eef6fc;color:#1d5685}.pd-flow-blue .pd-flow-solution{background:#dfeefa}.pd-flow-green{border-color:#b9dfc3;background:#eef8f0;color:#276944}.pd-flow-green .pd-flow-solution{background:#dff1e4}.pd-flow-merge{display:flex;justify-content:space-around;max-width:420px;margin:5px auto -3px;font-size:30px;font-weight:900;color:#4c7284}.pd-flow-goal{max-width:570px;margin:0 auto;background:#176744;color:#fff;border-radius:15px;padding:16px 18px;text-align:center;font-size:22px;font-weight:950;letter-spacing:-.3px;box-shadow:0 6px 14px rgba(23,103,68,.14)}
