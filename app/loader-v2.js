(async()=>{
  ...
  await Promise.all([
    import('./photo-room.js?v=1'),import('./project-access.js?v=1'),import('./password-reset.js?v=1'),import('./calendar-health.js?v=2'),import('./calendar-persistence.js?v=8'),import('./calendar-event-edit.js?v=6'),import('./calendar-date-create.js?v=2'),import('./task-workflow.js?v=2'),import('./task-layout.js?v=1'),import('./profile-settings.js?v=1'),import('./meeting-round-detail.js?v=1'),import('./project-files.js?v=1'),import('./library-upload.js?v=1'),import('./page-editor-fix.js?v=1')
  ]);
...
})().catch(err=>{console.error(err);document.body.insertAdjacentHTML('beforeend','<pre style="padding:16px;color:#a33b45">앱 초기화 오류: '+String(err.message||err)+'</pre>');});
