(async()=>{
  ...
  const ensureFeatureStyles=()=>featureStylesPromise||(featureStylesPromise=new Promise(resolve=>{
    ...
    link.rel='stylesheet';link.href='./styles.css?v=33';link.dataset.kptuFeatureStyles='1';
  ...
  const loadFeatures=()=>featurePromise||(featurePromise=(async()=>{
    ...
    await Promise.all([import('./google-tasks.js?v=4'),import('./push-notifications-ui.js?v=4'),import('./mobile-modal-history.js?v=1'),import('./mobile-swipe-navigation.js?v=4')]);
    featuresReady=true;
    startup?.mark('allInitialModulesComplete');
