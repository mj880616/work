(()=>{
  ...
  function installStyle(){
    ...
    style.textContent=`
      ...
      #pageList .card-actions .mini{display:inline-flex;align-items:center;justify-content:center;min-height:32px;padding:6px 10px;line-height:1;text-decoration:none;white-space:nowrap;border-radius:9px;box-sizing:border-box}
