...
test('task mutations have one canonical owner and obsolete task filters stay removed',async()=>{
  ...
  expect(index).toContain('./team.js?v=45');
  expect(index).toContain('./loader-v2.js?v=226');
  expect(index).toContain('./app.js?v=114');
  expect(loader).toContain("import('./team.js?v=45')");
  expect(app).toContain("import('./loader-v2.js?v=226')");
});
