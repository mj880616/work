...
test('page core and builder use explicit readiness without post-render correction',async()=>{
  ...
  expect(loader).toContain("page-list-controller.js?v=4");
  ...
  expect(loader).toContain("page-management.js?v=3");
  expect(loader).toContain('__KPTU_PAGE_MANAGEMENT_READY__');
  expect(loader).toContain("page-inline-viewer-v2.js?v=3");
  ...
  expect(styles).toContain("page-core.css?v=4");
