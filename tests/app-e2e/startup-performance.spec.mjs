...
test('startup assets are discovered from the document head without changing auth gates', async () => {
  ...
  expect(head).toContain('<script src="./app.js?v=98" defer></script>');
  expect(body).not.toContain('<script src="./app.js?v=98" defer></script>');
  for(const asset of [
    './loader-v2.js?v=210','./runtime-client.js?v=3','./native-auth-bridge.js?v=4',
    './calendar-return-bridge.js?v=3','./team.js?v=38','./home-dashboard-v2.js?v=8'
  ]) expect(head).toContain('rel="modulepreload" href="'+asset+'"');
  expect(read('app/app.js')).toContain("import('./loader-v2.js?v=210')");
  const loader=read('app/loader-v2.js');
  expect(loader).toContain("const runtimeReady=import('./runtime-client.js?v=3')");
  expect(loader).toContain("import('./team.js?v=38')");
