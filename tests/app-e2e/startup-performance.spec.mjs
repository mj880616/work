...
test('startup preloads only route-agnostic core assets', async () => {
  ...
  expect(head).toContain('<script src="./app.js?v=115" defer></script>');
  for(const asset of [
    './loader-v2.js?v=227','./runtime-client.js?v=4','./native-auth-bridge.js?v=4',
  ...
  expect(read('app/app.js')).toContain("import('./loader-v2.js?v=227')");
  const loader=read('app/loader-v2.js');
