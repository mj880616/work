...
test('startup preloads only route-agnostic core assets', async () => {
  ...
  expect(head).toContain('<script src="./app.js?v=122" defer></script>');
  for(const asset of [
    './loader-v2.js?v=234','./runtime-client.js?v=5','./native-auth-bridge.js?v=4',
  ...
  expect(read('app/app.js')).toContain("import('./loader-v2.js?v=234')");
  const loader=read('app/loader-v2.js');
  ...
  expect(loader).toContain("import('./view-loader.js?v=14')");
