...
- 최종 갱신일: 2026-09-26
- 기준 main SHA: `f4afd6e` (Merge pull request #294)
...
| Web1-1 | 공개 페이지 메타 생성기: 빈 조회 시 기존 메타 보존 (#202 재작업) | 완료 | #294 | withdrawn 목록으로 비공개 전환 명시, 빈 조회는 보존+실패. 9/22 빈 조회 원인 미확정, 로컬 조사 예정. #202는 merge 후 close |
