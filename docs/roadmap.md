...
| Web1-4 | app_delete_pages RPC 제거 (9/22 빈 조회 원인 경로 차단) | 진행중 | | migration 작성·로컬 합성 DB 검증까지. production 적용은 merge 후 별도 승인. 삭제 시 app_page_revisions도 cascade로 사라지는 구조는 범위 밖 |
